...
from meal_planner_connection.views import CreateUserView, LoginUserView, CustomTokenObtainPairView
...
urlpatterns = [
    ...
    path('meal_planner_connection/token/', CustomTokenObtainPairView.as_view(), name='get_token'),
