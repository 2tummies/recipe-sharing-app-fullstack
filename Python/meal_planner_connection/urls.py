...
urlpatterns = [
    ...
    path('recipes/', views.SharedRecipes.as_view(), name='shared-recipes-list'),
    path('recipes/<int:recipe_id>/', views.GetSharedRecipeById.as_view(), name='shared-recipe-by-id'),
    path('user/<int:user_id>/recipes/', views.EditUserRecipeList.as_view(), name='edit-saved-recipes')
]
